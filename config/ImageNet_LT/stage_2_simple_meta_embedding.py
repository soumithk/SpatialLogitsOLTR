...
training_opt['log_dir'] = './logs/ImageNet_LT/meta_embedding_simple'
...
networks['classifier'] = {'def_file': './models/SimpleMetaEmbeddingClassifier.py',

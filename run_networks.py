...
from loss.HallucinatorLoss import HallucinatorLoss
...
class model ():
    ...
    def init_criterions(self):
        ...
        # self.hallucinator_loss = HallucinatorLoss(self.config['training_opt']['num_classes'])
    ...
    def batch_loss(self, labels):
        ...
        # self.loss += self.hallucinator_loss(self.direct_memory_feature[2])
    ...
    def train(self):
        ...
        for epoch in range(1, end_epoch + 1):
            ...
            # self.networks['classifier'].module.set_epoch(epoch)
        ...
        for inputs, labels, paths in tqdm(self.data[phase]):
            ...
            with torch.set_grad_enabled(False):
                ...
                self.batch_forward(inputs, labels, 
                                   centroids=self.memory['centroids'],
                                   phase=phase)
                # print(list(zip(torch.argmax(self.direct_memory_feature[2], dim=1), labels)))
                # print(torch.sort(self.direct_memory_feature[2][0])[0][-16:])
